...
class NvmeofServiceSpec(ServiceSpec):
    def __init__(self,
                 ...
                 spdk_path: Optional[str] = None, # unused and duplicate of tgt_path bellow, consider removing
        ...
        #: ``spdk_path`` path is unused and duplicate of tgt_path bellow, consider removing
