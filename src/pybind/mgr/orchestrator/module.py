...
"""
        ...
        try:
            ...
            for drive_group_spec_bool_arg in list_drive_group_spec_bool_arg:
                drive_group_spec_value: str = drive_group_spec.get(drive_group_spec_bool_arg)
                if drive_group_spec_value.lower() not in ['true', 'false']:
                    raise OrchestratorValidationError(usage)
                drive_group_spec[drive_group_spec_bool_arg] = bool(drive_group_spec_value)
