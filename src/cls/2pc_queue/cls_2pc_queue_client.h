...
// update the push_endpoint address and its arguments in the header of the queue
...
int
cls_2pc_queue_get_topic_attrs_result(const bufferlist &bl, std::string &push_endpoint, std::string &push_endpoint_args,
