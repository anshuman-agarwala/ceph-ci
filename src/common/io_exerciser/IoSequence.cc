...
constexpr Sequence ceph::io_exerciser::Seq0::get_id() const
{
...
constexpr Sequence ceph::io_exerciser::Seq1::get_id() const
{
...
constexpr Sequence ceph::io_exerciser::Seq2::get_id() const
{
...
constexpr Sequence ceph::io_exerciser::Seq3::get_id() const
{
...
constexpr Sequence ceph::io_exerciser::Seq4::get_id() const
{
...
constexpr Sequence ceph::io_exerciser::Seq5::get_id() const
{
...
constexpr Sequence ceph::io_exerciser::Seq6::get_id() const
{
...
constexpr Sequence ceph::io_exerciser::Seq7::get_id() const
{
...
constexpr Sequence ceph::io_exerciser::Seq8::get_id() const
{
...
constexpr Sequence ceph::io_exerciser::Seq9::get_id() const
{
