...
void RadosIo::applyInjectOp(IoOp& op)
{
  ...
  case OpType::Write3:
    ...
    case OpType::InjectReadError:
    {
      ...
      ceph::io_exerciser::json::InjectECErrorRequest injectErrorRequest(ceph::io_exerciser::json::InjectOpType::Read,
                                                                        pool,
                                                                        oid,
                                                                        errorOp.shard,
                                                                        errorOp.type,
    ...
    case OpType::InjectWriteError:
    {
      ...
      ceph::io_exerciser::json::InjectECErrorRequest injectErrorRequest(ceph::io_exerciser::json::InjectOpType::Write,
                                                                        pool,
                                                                        oid,
                                                                        errorOp.shard,
                                                                        errorOp.type,
    ...
    case OpType::ClearReadErrorInject:
    {
      ...
      ceph::io_exerciser::json::InjectECClearErrorRequest clearErrorInject(ceph::io_exerciser::json::InjectOpType::Read,
                                                                           pool,
                                                                           oid,
                                                                           errorOp.shard,
                                                                           errorOp.type);
    ...
    case OpType::ClearWriteErrorInject:
    {
      ...
      ceph::io_exerciser::json::InjectECClearErrorRequest clearErrorInject(ceph::io_exerciser::json::InjectOpType::Write,
                                                                           pool,
                                                                           oid,
                                                                           errorOp.shard,
                                                                           errorOp.type);
