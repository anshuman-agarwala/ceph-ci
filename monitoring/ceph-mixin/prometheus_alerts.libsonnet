    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          'for': '1m',
          expr: '(count by(pool_name, image_name) (ceph_nvmeof_subsystem_namespace_metadata)) > 1',
          labels: { severity: 'warning', type: 'ceph_default' },
          annotations: {
            summary: 'RBD image {{ $labels.pool_name }}/{{ $labels.image_name }} cannot be reused for multiple NVMeoF namespace ',
